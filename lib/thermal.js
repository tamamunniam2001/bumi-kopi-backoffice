...
async function getReceiptSettings() {
  ...
  try {
    ...
    if (res.ok) _cachedSettings = await res.json()
  } catch {}
...
function resetSettingsCache() { _cachedSettings = null }

export { printThermal, buildReceipt, disconnectPrinter, resetSettingsCache }
